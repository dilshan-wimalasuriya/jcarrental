...
public class Admin {
    ...
    public boolean AddAdmin() throws SQLException{
        ...
        else
        {
            ...
            JOptionPane.showMessageDialog(null, "Admin Added Successfully. Press Refresh Table To View The Changes");
            return true;
        }
    }
    ...
    public boolean UpdateAdmin(String inputUname) throws SQLException{ 
        ...
        JOptionPane.showMessageDialog(null, "Admin Updated Successfully. Press Refresh Table To View The Changes");
        return true;
    }
